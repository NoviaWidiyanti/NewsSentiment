...
import itertools 
from wordcloud11 import vis_wordcloud
...
# 	return render_template('result-onepage.html')
...
def insight_line_chart():
	try:
		...
		# list_tanggal = df['publishedAts'].tolist()
		# list_tanggal = list(map(lambda x: x.strftime('%Y-%m-%d %H:%M:%S'), list_tanggal));
...
def insight_pie_chart():
	try:
		...
		# list_tanggal = []
		# for key in sentiment_dict_new["Negatif "]:
		# 	list_tanggal.append(key)
		# print(list_tanggal)
		# filter["tanggal"] = list_tanggal
